...
Start-Transcript -Path ("C:\AWSTools\logs\startup_" + $DATEANDTIME + ".log")
Write-Host("=========================================================================")
Write-Host("========================== Seat Startup =================================")
Write-Host("=========================================================================")
Write-Host ('[{0}] Forcing custom EDID' -f $DATEANDTIMELOG)
cmd.exe /C "echo y | C:\AWSTools\forcedisp\Win10-ForceDispx64.exe f C:\AWSTools\forcedisp\NvidiaVGX_custom_16_9_1920_1080.hex 0 100"
Write-Host ('[{0}] Setting native resolution in the base image' -f $DATEANDTIMELOG)
$nvDisplayResError = (Start-Process -FilePath 'C:\AWSTools\nvDisplayRes.exe' -ArgumentList '--x 1920 --y 1080' -Wait -PassThru).ExitCode
...
$GameSeatDisplayError = (Start-Process -FilePath 'C:\AWSTools\GameSeatDisplay.exe' -ArgumentList '--activate-display' -Wait -PassThru).ExitCode
